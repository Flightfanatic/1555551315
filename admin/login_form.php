...
<?php if (USE_USERNAME) echo '<label><strong>Username</strong></label><input type="text" name="access_login" id="user_login"  size="28" class="input"/>'; ?>
			<br />
			<label><strong>Password</strong></label><input type="password" name="access_password" id="user_pass"  size="28" class="input"/>
