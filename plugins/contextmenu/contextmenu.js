...
cmail.contextmenu_disable_multi = new Array('#reply','#reply-all','#forward','#print','#edit','#viewsource','#download','#open');
...
cmail.add_onload('if (cmail.message_list) cmail.message_list.addEventListener(\'select\', function(list) { rcm_selection_changed(list); } );');
