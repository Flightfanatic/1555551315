...
$(document).ready(function() {
  ...
  /* datepicker localization */
  $.dpText = {
    TEXT_PREV_YEAR: cmail.gettext('prev_year','calendar'),
    TEXT_PREV_MONTH: cmail.gettext('prev_month','calendar'),
    TEXT_NEXT_YEAR: cmail.gettext('next_year','calendar'),
    TEXT_NEXT_MONTH: cmail.gettext('next_month','calendar'),
    TEXT_CLOSE: cmail.gettext('cancel','calendar'),
    TEXT_CHOOSE_DATE: cmail.gettext('choose_date','calendar'),
  ...
  cmail.register_command('plugin.calendar_datepicker', selectDate, true);
