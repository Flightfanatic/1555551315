<html>
<head>
<title>Creating Configureation File | Crystal Installer</title>
...
if (!empty($_POST['submit'])) {
  ...
  echo ' (names above the text box) within the <tt>'.cmail_CONFIG_DIR.'</tt> directory of your Crystal installation.<br/>';
  ...
  echo '<p class="hint">Of course there are more options to configure.
    Have a look at the config files or visit <a href="http://trac.Crystal.net/wiki/Howto_Config">Howto_Config</a> to find out.</p>';
...
?>
<label for="cfgautocreate">Automatically create a new Crystal user when log-in the first time</label><br />
...
<p class="hint">If this option is disabled, the login only succeeds if there's a matching user-record in the local Crystal database
